...
- ${<GithubRepositoryLink user={'futurice'} repo={'pepperoni-app-kit'} title={'Pepperoni App Kit'} />}
- ${<GithubRepositoryLink user={'bartonhammond'} repo={'snowflake'} title={'Snowflake'} />}
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <ul>
            <li>Boilerplates correctly configure many complex technologies, making sure they work together, and provide a good developer experience (many libraries need custom configuration to work with hot reloading, etc).<br /><br /></li>
          </ul>
          <ul>
      ...
      <tr>
        ...
        <td>
          <ul>
            <li>A boilerplate is unlikely to make the same technical decisions that you would about your app, given that: you know your use case best, and you may have experience with certain libraries that you want to leverage. You'll never find a perfect boilerplate.<br /><br /></li>
          </ul>
          <ul>
            <li>Boilerplates attempt to work for a broad set of use cases. They will almost certainly contain libraries and starter files that you won't need, and that you'll want to delete before you start working. You may also want to add or swap libraries.<br /><br /></li>
          </ul>
          <ul>
            <li>Boilerplates tend to be large, and may contain a lot of unfamiliar code. Part of the unfamiliar code may even be unique to the boilerplate, so nobody on your team will be familiar with it either. You'll have to start by learning your boilerplate inside and out.<br /><br /></li>
          </ul>
          <ul>
            <li>When you want to update React Native, you'll have to make sure all of your project's dependencies work with the new version. Since boilerplates tend to include a lot of dependencies, you may have a lot of work to do before your app runs successfully again.<br /><br /></li>
          </ul>
        </td>
      </tr>
    </tbody>
