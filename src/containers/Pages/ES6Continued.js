      ...
      <Page title={'ES6 Continued'}>
        <div style={styles.well}>
          ...
          <EditorTranspiler
            ...
            inputHeader={
              <div>
                Using <code style={styles.cmHeaderCode}>class</code>
              </div>
            }
            outputHeader={'Output compiled with Babel'}
          />
          ...
          <EditorTranspiler
            value={classExtendsExample}
            inputHeader={'Inheritance'}
            outputHeader={'Output compiled with Babel'}
          />
          <div style={styles.p}>
          ...
          <EditorTranspiler
            value={dynamicObjectKeysExample}
            inputHeader={'Dynamic object keys'}
            outputHeader={'Output compiled with Babel'}
          />
          ...
          <EditorTranspiler
            value={arraySpreadExample}
            inputHeader={'Array spread operator'}
            outputHeader={'Output compiled with Babel'}
          />
        </div>
        <div style={styles.well}>
