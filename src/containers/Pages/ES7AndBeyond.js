    ...
    return (
      <Page title={'ES7AndBeyond'}>
        <div style={styles.well}>
          ...
          <EditorTranspiler
            value={staticPropertyExample}
            inputHeader={
              <div>
                <code style={styles.cmHeaderCode}>Static properties</code>
              </div>
            }
          ...
          <EditorTranspiler
            value={boundInstanceMethodsExample}
            inputHeader={
              <div>
                <code style={styles.cmHeaderCode}>Bound instance methods</code>
              </div>
            }
            outputHeader={'Output compiled with Babel'}
          />
          ...
          <EditorTranspiler
            value={objectSpreadExample}
            inputHeader={
              <div>
                <code style={styles.cmHeaderCode}>Object spread operator</code>
              </div>
            }
            outputHeader={'Output compiled with Babel'}
          />
          ...
          <EditorTranspiler
            value={asyncAwaitExample}
            inputHeader={
              <div>
                <code style={styles.cmHeaderCode}>Async/Await</code>
              </div>
            }
            outputHeader={'Output compiled with Babel'}
          />
